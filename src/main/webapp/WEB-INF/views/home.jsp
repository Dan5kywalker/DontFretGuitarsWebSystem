        ...
        <div class="item active">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Don't Fret Guitars</h1>

                    <p>Browse through our amazing catalogue of products with some of the best deals around!</p>
                </div>
            </div>
        </div>
        <div class="item">
            ...
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <p><a href="<c:url value="/product/productList"/>" class="btn btn-lg btn-primary">Browse Our Catalogue!</a></p>
                </div>
            </div>
        </div>
        <div class="item">
...
<div class="container marketing">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <img class="img-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="140" height="140">
            <h2>Electric Guitar Amplifiers</h2>
            <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh.</p>
            <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
